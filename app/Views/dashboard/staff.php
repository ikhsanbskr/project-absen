<body onload="getLocation();">
    <div class="row">
        <div class="col-sm-12 mt-3">
            <h3 style="color: #4a4a4a;">Dashboard Absensi</h3>
            <hr>
            <!-- Session validasi -->
            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-hoover text-center" id="tb_dashboard">
                        ...
                        <tbody>
                            <?php $no = 1;  ?>
                            <?php foreach ($staff as $row => $value) : ?>
            ...
            <div class="card">
                <div class="card-body">
                    <form class="formAbsen" action="checkin" method="POST" id="form-absen" style="display: inline;">
                        ...
                        <input type="hidden" name="status" value="<?= date('H:i:s') >= user()->jam_terlambat ? 'Terlambat' : 'Hadir' ?>">
                    ...
                    <div class="modal fade" id="checkout" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <form action="checkout/<?= ($lastinput->id == '') ? '0' : $lastinput->id ?>" method="POST">
                                <?= csrf_field() ?>
                                <div class="modal-content">
                                    <div class="modal-header">
                    ...
                    <button type="submit" class="btn btn-secondary mt-3" data-toggle="modal" data-target="#izin">Izin</button>
                    <!-- Modal Izin -->
                    <div class="modal fade" id="izin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <form action="izin" method="POST" id="form-izin">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <input type="hidden" name="lokasi" id="lokasi-izin">
                                        <label>Keterangan Izin</label>
                                        <textarea name="keterangan" class="form-control" maxlength="31" rows="2"></textarea>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                        <button type="submit" class="btn btn-primary">Konfirmasi</button>
