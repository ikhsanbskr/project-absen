                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">Tulis emailmu agar kami dapat mengirimkan link untuk mengatur ulang password mu.</p>
                                    </div>
                                    <form class="user" action="<?= url_to('forgot') ?>" method="post">
                                        <?= csrf_field() ?>
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user <?php if (session('errors.email')) : ?>is-invalid<?php endif ?>" name="email" aria-describedby="emailHelp" placeholder="Masukkan email...">
