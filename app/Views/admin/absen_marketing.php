    ...
    <div class="card">
      <div class="card-body">
        <div class="col-sm-12 text-center">
          <h6>LAPORAN KEHADIRAN SEMUA MARKETING</h6>
        ...
        <div class="row">
          ...
          <div class="col-sm-6 text-right mb-2">
            <form action="/absen-marketing/laporan" method="POST">
              <button class="btn btn-md btn-secondary" onclick="this.form.target='_blank'; return true;"><i class='fas fa-print'></i> Export Laporan</button>
            </form>
          </div>
        </div>
