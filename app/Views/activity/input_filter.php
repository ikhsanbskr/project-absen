        ...
        <div class="row">
          <div class="col-sm-12">
            <form action="/activity/filter" method="GET">
              <input type="text" id="min" name="select-tanggal" class="form-control mt-2 col-sm-12" style="display:inline;" placeholder="Masukkan tanggal.." value="<?= $tanggal ?>">
              <br>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Aktifitas</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        <div class="modal-body">
                          <form action="/activity/filter/edit/<?= $row->activityid ?>" method="POST" id="form-edit<?= $no ?>">
                            <?= csrf_field() ?>
                            <input type="hidden" name="tanggal" value="<?= $row->tanggal_activity ?>">
                            <textarea name="activity_edit" class="form-control" maxlength="200"><?= $row->aktifitas ?></textarea>
                            <p style="color: red; font-size:small;" class="pl-1">*Maksimal 200 kata</p>
                          </form>
                        </div>
...
<div class="modal fade" id="tambahModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="/activity/filter/tambah" method="POST">
        <div class="modal-body">
          <input type="hidden" name="tanggal" value="<?= $tanggal ?>">
          <textarea name="activity" class="form-control" placeholder="Aktifitas 1, Aktifitas 2, Aktifitas 3..." maxlength="200"></textarea>
          <p style="color: red; font-size:small;" class="pl-1">*Maksimal 200 kata</p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
