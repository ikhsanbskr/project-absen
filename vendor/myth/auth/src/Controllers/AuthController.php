...
class AuthController extends Controller
{
    ...
    public function attemptLogin()
    {
        ...
        if (!$this->auth->attempt([$type => $login, 'password' => $password], $remember)) {
            return redirect()->back()->withInput()->with('error', 'Kata sandi yang Anda masukkan salah.' ?? lang('Auth.badAttempt'));
        }
    ...
    public function attemptRegister()
    {
        ...
        $rules = config('Validation')->registrationRules ?? [
            ...
            'email' => [
                ...
                'errors' => [
                    ...
                    'valid_email' => 'Input email harus menggunakan alamat email yang valid.',
            ...
            'jabatan' => [
                'rules' => 'required|alpha_numeric_punct|min_length[3]|max_length[100]',
                'errors' => [
                    'required' => 'Jabatan wajib diisi.',
                    'alpha_numeric_punct' => 'Jabatan tidak boleh mengandung simbol.',
                    'min_length' => 'Jabatan tidak boleh kurang dari 3 kata.',
        ...
        $rules = [
            'password' => [
                ...
                'errors' => [
                    'required' => 'Password wajib diisi.',
                    'strong_password' => 'Password harus mengandung sandi yang kuat.'
                ]
            ],
            'pass_confirm' => [
